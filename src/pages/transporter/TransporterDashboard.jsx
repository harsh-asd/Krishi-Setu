    ...
    <article style={styles.jobCard}>
      ...
      <div style={styles.jobMain} className="sih-transporter-job-main">
        ...
        <div>
          ...
          <div style={{fontSize: '9px', color: "#1c1917", marginTop: '2px', fontFamily: 'monospace'}}>
...
const styles = {
  commandQuickBar: {
    ...
    padding: "13px 15px",
    borderRadius: "16px",
    background: "rgba(235, 185, 70, 0.35)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", border: "1px solid rgba(255, 215, 0, 0.4)", boxShadow: "0 8px 32px rgba(0, 0, 0, 0.15)",
